...
@Controller
public class SortsStringController {

    @GetMapping("/SanviSortsString")
    public String sorter(
        ...
        String[] arrayToSort = {id0, id1, id2, id3, id4, id5, id6, id7, id8, id9};
        ...
        return "SanviMinilab/SanviSortsString";
    }
}
